...
class Constant{
  static const splash_screenBackColor = const Color(0xffE7FFEF);
  static const primaryColor = const Color(0xff39B54A);
  static const primaryTextColorGray= const Color(0xff808080);
