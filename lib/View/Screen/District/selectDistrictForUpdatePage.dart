...
class DistrictCategoryForUpdateScreen extends StatefulWidget {
  @override
  _DistrictCategoryForUpdateScreenState createState() => _DistrictCategoryForUpdateScreenState();
}

class _DistrictCategoryForUpdateScreenState extends State<DistrictCategoryForUpdateScreen> {
          ...
          title:Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: (){
                  showSearch(context: context, delegate: SearchForDistrictTypeForUpdateScreen(_districtList));
                },
              )
            ],
          ),
...
class SearchForDistrictTypeForUpdateScreen extends SearchDelegate<dynamic>  {
  final List<FetchAllDistrict> districtList;
  SearchForDistrictTypeForUpdateScreen(this.districtList);
  // String radioItem = '';
...
//  List<String> recentList = ["Text 4", "Text 3"];
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    return GetBuilder<DistrictControllerForUpdateScreen>( // specify type as Controller
      init: DistrictControllerForUpdateScreen(), // intialize with the Controller
